                ...
                html = `
                    <div class="media-split-layout" style="display: flex; width: 100%; height: 100%; align-items: center; justify-content: space-between; gap: 40px; padding: 40px; box-sizing: border-box;">
                        ...
                        <div class="media-right" style="flex: 1; display: flex; align-items: center; justify-content: center;">
                            <video id="slide-video" preload="auto" src="${slide.videoSrc}" style="width: 120%; max-height: 105vh; object-fit: contain; transform-origin: bottom center; transform: scale(2.9) translate(-5%, 8%);" muted playsinline></video>
                        </div>
                        ...
                        <div class="media-left" style="flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; position: relative;">
                            ...
                            <div class="part-6-content" style="position: absolute; display: flex; flex-direction: column; align-items: center; justify-content: center; width: 100%; top: 50%; transform: translateY(-50%); pointer-events: none;">
                                ...
                                <div class="gs-part6-flow" style="display: flex; justify-content: center; align-items: center; gap: 10px; width: 100%; direction: rtl;">
                                    ...
                                    <div class="flow-step gs-step6" style="background: linear-gradient(135deg, #1ca68d, #147361); color: white; width: 140px; aspect-ratio: 1; height: auto; border-radius: 50%; display: flex; flex-direction: column; justify-content: center; align-items: center; font-weight: bold; font-size: 18px; box-shadow: 0 5px 15px rgba(28, 166, 141, 0.4); opacity: 0; transform: scale(0.5); text-align: center; flex-shrink: 1; border: 3px solid rgba(255,255,255,0.2);">التوجيه <span style="color: #FFEBEE; font-size: 14px; margin-top: 5px;">(المجلس)</span></div>
                                    
                                    <div class="flow-arrow gs-step6" style="color: #1ca68d; font-size: 24px; opacity: 0; flex-shrink: 1;">◀</div>
                                    
                                    <div class="flow-step gs-step6" style="background: linear-gradient(135deg, #1B3B5A, #0e2031); color: white; width: 140px; aspect-ratio: 1; height: auto; border-radius: 50%; display: flex; flex-direction: column; justify-content: center; align-items: center; font-weight: bold; font-size: 18px; box-shadow: 0 5px 15px rgba(27, 59, 90, 0.4); opacity: 0; transform: scale(0.5); text-align: center; flex-shrink: 1; border: 3px solid rgba(255,255,255,0.2);">التحليل <span style="color: #FFEBEE; font-size: 14px; margin-top: 5px;">(اللجان)</span></div>
                                    
                                    <div class="flow-arrow gs-step6" style="color: #1B3B5A; font-size: 24px; opacity: 0; flex-shrink: 1;">◀</div>
                                    
                                    <div class="flow-step gs-step6" style="background: linear-gradient(135deg, #CFA043, #A57D2C); color: white; width: 140px; aspect-ratio: 1; height: auto; border-radius: 50%; display: flex; flex-direction: column; justify-content: center; align-items: center; font-weight: bold; font-size: 18px; box-shadow: 0 5px 15px rgba(207, 160, 67, 0.4); opacity: 0; transform: scale(0.5); text-align: center; flex-shrink: 1; border: 3px solid rgba(255,255,255,0.2);">الضبط <span style="color: #FFEBEE; font-size: 14px; margin-top: 5px;">(المصفوفة)</span></div>
                                    
                                    <div class="flow-arrow gs-step6" style="color: #CFA043; font-size: 24px; opacity: 0; flex-shrink: 1;">◀</div>
                                    
                                    <div class="flow-step gs-step6" style="background: linear-gradient(135deg, #023230, #011c1b); color: white; width: 140px; aspect-ratio: 1; height: auto; border-radius: 50%; display: flex; flex-direction: column; justify-content: center; align-items: center; font-weight: bold; font-size: 18px; box-shadow: 0 5px 15px rgba(2, 50, 48, 0.4); opacity: 0; transform: scale(0.5); text-align: center; flex-shrink: 1; border: 3px solid rgba(255,255,255,0.2);">الإلزام <span style="color: #FFEBEE; font-size: 14px; margin-top: 5px;">(السياسات)</span></div>
                                    
                                    <div class="flow-arrow gs-step6" style="color: #023230; font-size: 24px; opacity: 0; flex-shrink: 1;">◀</div>
                                    
                                    <div class="flow-step gs-step6" style="background: linear-gradient(135deg, #D32F2F, #9a0007); color: white; width: 140px; aspect-ratio: 1; height: auto; border-radius: 50%; display: flex; flex-direction: column; justify-content: center; align-items: center; font-weight: bold; font-size: 18px; box-shadow: 0 5px 15px rgba(211, 47, 47, 0.4); opacity: 0; transform: scale(0.5); text-align: center; flex-shrink: 1; border: 3px solid rgba(255,255,255,0.2);">التنفيذ <span style="color: #FFEBEE; font-size: 14px; margin-top: 5px;">(الإجراءات)</span></div>
            ...
            modal.innerHTML = `
                <div class="modal-content" style="background: white; border-radius: 20px; width: 850px; max-width: 90%; padding: 50px; position: relative; transform: scale(0.8); transition: transform 0.3s; text-align: right;" dir="rtl">
                    ...
                    <div style="display: flex; gap: 40px; align-items: center;">
                        <div id="modal-icon" style="width: 200px; height: 200px; flex-shrink: 1; border-radius: 50%; overflow: hidden; border: 1px solid #ccc; box-shadow: 0 5px 15px rgba(0,0,0,0.1);"></div>
                        <div>
